...
description: "这可能会存在一些争议，据我所知 async/await 这个特性受到很多开发者的青睐。对于不熟悉的同学，简单讲，其实它就是一种让开发者处理 Promise 更漂亮点儿的原生语法。  async/await 写法： ``` javascript async function doSomethingC..."
publishedAt: "2017-08-05"
updatedAt: "2017-08-05"
image: "./images/cover.webp"
isPublished: true
author: "Cayden"
tags: ["JavaScript", "Async/Await", "Promise", "异步编程"]
slug: "async-await-advantages-and-disadvantages-translation"
key: "async-await-advantages-disadvantages"
tagKeys: ["JavaScript", "Async/Await", "Promise", "异步编程"]
language: "zh-cn"
---
